    ...
    <div class="main-container">
        <div class="print-healtheval-data">
            <div class="col-md-2 offset-md-10 mb-4">
                <a href="{{route('clinicstaff/printAll/consultation-record', $patient_id)}}" id="print-healtheval-data"><i class="fa fa-print"></i>&nbsp Print All Record</i></a>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-1 con-rec-printOne">
                <div class="form-group">
                    <a href="{{route('clinicstaff/print/health-eval', $record->id)}}" class="btn btn-success" id="con-rec-printOne"><i class="fa fa-print"></i></a>
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
                    <a href="{{route('clinicstaff/archive/consultation-record', $record->id)}}" onclick="confirmArchive()" class="btn btn-danger" ><center><i class="fas fa-trash-alt"></i></center></a>
                </div>
            </div>
        </div>
    @endforeach
