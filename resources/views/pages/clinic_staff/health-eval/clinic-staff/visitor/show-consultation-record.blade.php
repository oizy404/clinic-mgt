    ...
    <div class="main-container">
        <div class="print-healtheval-data">
            <div class="col-md-3 offset-md-9 mb-4">
                <a href="{{route('clinicstaff/printVisitorAll/consultation-record', $visitor_id)}}" id="print-healtheval-data" style="margin-left: 40px;"><i class="fa fa-print"></i>&nbsp Print All Record</i></a>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                @endif
                                <a href="{{route('clinicstaff/editVisitor/health-eval', $record->id)}}"><i class="fa fa-edit"></i> Edit Evaluation</a>
                            </div>
                        </div>
                    </div>
                </div>
