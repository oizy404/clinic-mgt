...
<style>
    ...
    <div class="print-healtheval-data">
            <div class="col-md-3 offset-md-9 mb-4">
                <a href="{{route('doctor/printAll/consultation-record', $patient_id)}}" id="print-healtheval-data" style="margin-left: 40px;"><i class="fa fa-print"></i>&nbsp Print All Record</i></a>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                @endif
                                <a href="{{route('doctor/edit/consultation-record', $record->id)}}"><i class="fa fa-edit"></i> Edit Evaluation</a>
                            </div>
                        </div>
                    </div>
                </div>
