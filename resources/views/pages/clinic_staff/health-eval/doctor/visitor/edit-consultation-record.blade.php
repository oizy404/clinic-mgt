        ...
        <div class="main-container">
            <div class="add-consultation-record">
                ...
                <div class="" id="add-consultation-record">
                    <form action="{{route('doctor/update/consultation-record', $record->id)}}" method="post">
                        @csrf
                        @method('post')
                            ...
                            <div class="row">
                                <div class="col column1">
                                    <div class="col form-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="complete_name" id="complete_name" value="{{$record->visitor->first_name}} {{$record->visitor->last_name}}" data-bs-toggle="modal" data-bs-target="#patientModal">
                                        <input type="hidden" class="form-control" name="visitorId" value="{{$record->visitor_id}}" id="id">
                                    </div>
                                </div>
                                <div class="col" id="column2">  
                                    <div class="col form-group input-group-sm" id="employeeStatColumn">
                                        ...
                                        <input type="text" class="form-control" id="patient_status" value="{{$record->visitor->patient_role}}">
                                    </div>                                
                                </div>
                            </div>
                            <div class="row mt-3">
