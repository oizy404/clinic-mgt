...
@section('content')
<style>
    #viewuserhlt-subhead hr{
        margin-bottom: 0px;
        margin-top: 4px;
    }
    #viewuserhlt-subhead a{
        color: #0266ea;
    }
    #viewuserhlt-subhead i{
        color: #1067d8;
        font-size: 20px;
    }
</style>
...
@include('shared.patient-sidenav') 
        <div class="main-container">
            <div class="add-health-data">
                <div class="row mb-4" id="viewuserhlt-subhead">
                    <div class="col-md-11" style="margin: auto; padding: 0px;">
                        <div class="row">
                            <div class="col-md-3">
                                <i class="fa fa-pen"></i> <a href="{{route('edit-healthData', $patient->id)}}" >Update Health Data</a>
                            </div>
                            <div class="col-md-3">
                                <i class="fa fa-print"></i> <a href="#" data-bs-toggle="modal" data-bs-target="#newUserAccount">Print Health Data</a>
                            </div>
