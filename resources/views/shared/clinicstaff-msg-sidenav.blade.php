                    ...
                    @foreach($patients as $patient)
                        ...
                        @else
                            ...
                            <tr>
                                ...
                                ?>
                                <td>
                                    <a href="{{route('clinicstaffViewCreate', $user->first()->id)}}"><img src="{{ Avatar::create($fullname)->toBase64()}}" class="patient-avatar" alt="patient-avatar"> {{$patient->first_name}} {{$patient->last_name}}</a>
                                    <hr>
                                </td>
